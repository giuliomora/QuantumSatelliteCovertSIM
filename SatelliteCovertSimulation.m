...
% Il Macro-Doppler Orbitale (7.6 km/s del satellite)
Shift_Orbitale = 0.4; % Il segnale arriva shiftato del 40% dal centro

% Generazione del Profilo Classico (Effetto Doppler termico)
sigma_doppler = 0.15; 
S_classico = exp(-((omega - Shift_Orbitale).^2) / (2 * sigma_doppler^2));
 
%L'atomo è sul satellite, il segnale quantistico deve subire lo stesso
...
% TRACKING SATELLITARE (Compensazione Macro-Doppler)
...
% CLUTTER REJECTION (Rimozione del Bias Termico)
